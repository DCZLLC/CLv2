...
#ifndef CL_SCRIPT_STANDARD_H
#define CL_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_CL_ASSET script that carries data
    /** CL END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a cl address
 */
...
/**
 * Generate a Cl scriptPubKey for the given CTxDestination. Returns a P2PKH
