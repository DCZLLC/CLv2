...
// Copyright (c) 2022-2023 CL developers
...
public:
    CMainParams() {
     ...
     //   consensus.nSubsidyHalvingInterval = 1000000;  //~ 1.9 years at 1 min block time
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000ede954e24f387e"); // New blockchain, no work done yet

        // By default assume that the signatures in ancestors of this block are valid. Block# 0
        consensus.defaultAssumeValid = uint256S("0x00000000000262dbd8805d8ed2bbff47e709d6c04b5bd9590d0121087d304977"); // Genesis block
	    ...
	    uint32_t nGenesisTime = 1703650172; // October 30, 2023, at 00:00:00 UTC

	    genesis = CreateGenesisBlock(nGenesisTime, 7132946, 0x1e00ffff, 4, 5000 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000eb1a028455ccf13a58de5f1e8cca706094138209c72e4a1f4c147cff88"));
        assert(genesis.hashMerkleRoot == uint256S("e04a78dcf0ad3d5c7f1ac4460c4c04bc333e677d52371b7453b5b09603b41d54"));

        vSeeds.emplace_back("82.165.213.229", false);
        vSeeds.emplace_back("74.208.38.153", false);
        ...
        // CL BIP44 cointype in mainnet is '2686'
        nExtCoinType = 2686;
        ...
        // 5% of 500 CL to operations wallet
        ...
        // CL Operations Fund
        strCommunityAutonomousAddress = "AcUerJLseUZBUn4HtUorr4zp9fhiV62jzf";
        ...
        nKAAAWWWPOWActivationTime = 1704005811;
...
*/
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the CL chain
	    ...
	    // 5% of 500 CL to operations fund
	    nCommunityAutonomousAmount = 5;
