...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ClAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cl-qt -platform xcb      # Linux
//     src/qt/test/test_cl-qt -platform windows  # Windows
//     src/qt/test/test_cl-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ClUnits::formatWithUnit(unit, balance, false, ClUnits::separatorAlways);
    ...
    // Amount input
    ClAmountField* amountInput = receiveCoinsDialog.findChild<ClAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cl:")) != -1);
