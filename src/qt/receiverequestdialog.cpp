...
#include "config/cl-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatClURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ClUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatClURI(info));
}
