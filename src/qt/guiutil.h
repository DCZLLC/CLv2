...
#ifndef CL_QT_GUIUTIL_H
#define CL_QT_GUIUTIL_H
...
/** Utility functions used by the cl Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cl:" URI into recipient object, return true on successful parsing
