...
#ifndef CL_QT_CLUNITS_H
#define CL_QT_CLUNITS_H
...
/** cl unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ClUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ClUnits(QObject *parent);
...
typedef ClUnits::Unit ClUnit;

#endif // CL_QT_CLUNITS_H
