...
#ifndef CL_QT_ClGUI_H
#define CL_QT_ClGUI_H
...
/**
  cl GUI main class. This class represents the main window of the cl UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ClGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ClGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ClGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a cl wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
