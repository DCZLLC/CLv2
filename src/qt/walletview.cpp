...
void WalletView::setClGUI(ClGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? ClGUI::HD44_ENABLED : _walletModel->hdEnabled() ? ClGUI::HD_ENABLED : ClGUI::HD_DISABLED);
