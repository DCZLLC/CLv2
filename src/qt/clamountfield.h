...
#ifndef CL_QT_ClAmountField_H
#define CL_QT_ClAmountField_H
...
/** Widget for entering cl amounts.
  */
class ClAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit ClAmountField(QWidget *parent = 0);
