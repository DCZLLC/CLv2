/* src/config/cl-config.h.  Generated from cl-config.h.in by configure.  */
/* src/config/cl-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Cl Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Cl Core"
...
#define PACKAGE_BUGREPORT "https://github.com/AIPowerGrid/AI-Power-Grid-Core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CL Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CL Core 1.1.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "CL"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://aip"
