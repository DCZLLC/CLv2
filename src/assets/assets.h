...
#ifndef CLCOIN_ASSET_PROTOCOL_H
#define CLCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_CL_ASSET clQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_CL_ASSET clO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_CL_ASSET clR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_CL_ASSET clT
