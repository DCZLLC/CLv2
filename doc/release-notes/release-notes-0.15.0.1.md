CL Core version *0.15.0.1* is now available from:

  <https://cl.org/bin/cl-core-0.15.0.1/>

and

  <https://clcoin.org/bin/cl-core-0.15.0.1/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cl/).
