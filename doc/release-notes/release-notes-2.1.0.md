CL Core version *2.1.0* is now available!!
==============

  <https://github.com/CLProject/CLcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/CLProject/CLcoin/commits/release_2.1.0>
