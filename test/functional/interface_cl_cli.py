...
class TestClCli(ClTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `cl-cli getinfo`")
        ...
        self.log.info("Compare responses from `cl-cli -getinfo` and the RPCs data is retrieved from.")
