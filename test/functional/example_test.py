...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ClTestFramework
    pass

class ExampleTest(ClTestFramework):
    # Each functional test is a subclass of the ClTestFramework class.
    ...
    def custom_method(self):
        ...
        ClTestFramework class so other tests can use it."""
