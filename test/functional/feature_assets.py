...
class AssetTest(ClTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="CL*", verbose=False, count=2, start=-2)
        ...
        cl_assets = n0.listassets(asset="CL*", verbose=False, count=2, start=-2)
        assert_equal(len(cl_assets), 2)
        assert_equal(cl_assets[0], "CL2")
        assert_equal(cl_assets[1], "CL3")
        self.sync_all()
