...
class TxnMallTest(ClTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 cl:
        ...
        # First: use raw transaction API to send 1240 cl to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 cl coin each
        ...
        # Node0's balance should be starting balance, plus 50cl for another
        ...
        # Node0's total balance should be starting balance, plus 100cl for
