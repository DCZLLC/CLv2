...
By default, cld will dump mempool on shutdown and
...
class MempoolPersistTest(ClTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give cld a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent cld from writing mempool.dat to disk. Verify that `savemempool` fails")
