...
class WalletTest(ClTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 cl from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 cl with subtract fee from amount
        ...
        # Sendmany 10 cl with subtract fee from amount
