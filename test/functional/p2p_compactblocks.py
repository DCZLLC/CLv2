...
# TestNode: A peer we use to send messages to cld, and store responses.
...
class CompactBlocksTest(ClTestFramework):
    ...
    # This test actually causes cld to (reasonably!) disconnect us, so do this last.
    ...
    # Test that cld requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cld to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # cld will not send blocktxn responses for blocks whose height is
