...
import os
import struct
from test_framework.test_framework import ClTestFramework, SkipTest
...
class ZMQTest(ClTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that cl has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("cld has not been built with zmq enabled.")
